...
/**
 * ClassName: RuleWeightLogicChain.java <br>
 *
 * @author AlfredOrlando <br>
 * <p>
 * Created: 2024-05-09 20:32 <br> Description: 规则权重过滤器链 <br>
 * <p>
 * Modification History: <br> - 2024/5/9 AlfredOrlando 规则权重过滤器链 <br>
 */
@Slf4j
...
public class RuleWeightLogicChain extends AbstractLogicChain {
    ...
    public Integer logic(String userId, Long strategyId) {
        ...
        log.info("抽奖责任链-权重解析规则值 ruleValue: {}", ruleValue);
